...
<div class="row">
    ...
    <div class="col-md-6 order-md-1">
      ...
      <form  action="guardar_nivel.php?ID_Curso=<?php echo $filas['ID_Curso']?>" method="POST" id="form" enctype="multipart/form-data">
...
<div class="input-contenedor">
  ...
  ?>
<select name="nivelpadre_id" id="nivelpadre_id" required>
        <option value="0">Crear Nuevo Nivel</option>
...
<div class="input-contenedor">
    <input type="text" name="nivel_nombre" id="nivel_nombre" placeholder="Nombre de usuario">

</div>


<input type="submit" value="agregar_nivel" name="agregar_nivel" class="button">
